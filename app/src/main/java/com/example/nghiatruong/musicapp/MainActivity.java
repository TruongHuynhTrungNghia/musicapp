...
import com.example.nghiatruong.musicapp.AudioPlayerActivity;
import com.example.nghiatruong.musicapp.PlayerConstants;
import com.example.nghiatruong.musicapp.Controls;
import com.example.nghiatruong.musicapp.Song;
import com.example.nghiatruong.musicapp.SongService;
import com.example.nghiatruong.musicapp.UltilFunctions;
import com.example.nghiatruong.musicapp.SongApdapter;
...
public class MainActivity extends AppCompatActivity {
        ...
        SongApdapter songApdapter=null;
        ...
        private void setListItems() {
            songApdapter=new SongApdapter(this,R.layout.custom_list,PlayerConstants.SONG_LIST);
            songListView.setAdapter(songApdapter);
        ...
        private static void updateUI() {
            try{
                ...
                Bitmap albumArt=(Bitmap) UltilFunctions.getAlbumImg(context,song.getAlbumID());
                if(albumArt!=null){
